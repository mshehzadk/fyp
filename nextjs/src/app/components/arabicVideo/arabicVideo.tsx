...
export default function arabicVideo() {
    ...
    <div className=" bg-black pb-10">
        <div className="videoupload mx-auto p-1 bg-gray-400  shadow-md w-full">
          <header className="bg-gradient-to-r from-pink-900 to-purple-900 text-white py-3 transition ease-in-out delay-150 hover:scale-100 hover:bg-orange-400 duration-300">
        ...
        <div className="w-screen flex flex-col justify-center items-center py-0 bg-black">
            ...
            <div className="flex flex-col lg:flex-row">
                ...
                {/* Left Image */}
                <div className="w-2/4 lg:w-1/2 border-2 border-black hidden lg:block mr-1" style={{ width: "450px", height: "400px" }}>
                <img
                ...
                {/* Right Image */}
                <div className="w-2/4 lg:w-1/2 border-2 border-black hidden lg:block ml-1" style={{ width: "450px", height: "400px" }}>
                <img
                    src="https://wallpapercave.com/wp/wp5886498.jpg"
                    alt="Right Image"
                    className="w-full h-full object-cover"
