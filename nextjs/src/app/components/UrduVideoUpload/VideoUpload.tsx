  ...
  return (
    <>
      <div className="videoupload mx-auto p-2 bg-black  shadow-md w-full">
        <header className="bg-gradient-to-r from-purple-900 via-blue-900 to-blue-400  text-white py-5 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-100 hover:bg-orange-400 duration-300">
